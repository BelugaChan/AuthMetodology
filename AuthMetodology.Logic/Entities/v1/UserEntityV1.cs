...
namespace AuthMetodology.Logic.Entities.v1
{
    ...
    public class UserEntityV1
    {
        ...
        public static UserEntityV1 Create(Guid id,string passwordHash, string email, string refreshToken, DateTime refreshTokenExpiry, string idGoogle, bool is2FaEnabled)
        {
